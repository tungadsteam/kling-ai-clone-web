...
var addSubcommand = {
  ...
  options: [
    ...
    {
      name: "missing",
      description: "Condition that must NOT match: type:key or type:key:value (repeatable)",
      shorthand: null,
      type: [String],
      argument: "CONDITION",
      deprecated: false
...
var editSubcommand = {
  ...
  options: [
    ...
    {
      name: "missing",
      description: "Add a missing condition: type:key or type:key:value (repeatable)",
      shorthand: null,
      type: [String],
      argument: "CONDITION",
      deprecated: false
